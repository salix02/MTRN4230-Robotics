%% general purpose fill deck function
function fillDeck(vid1,vid2,handle)
%fillDeck
%   it checks if any cell in any deck is empty and fill the deck by picking
%   up blocks in box and putting down in the desired location in either
%   deck.
