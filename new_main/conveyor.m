function out = conveyor
%CONVEYOR Code for creating a video input object.
%   
%   This is the machine generated representation of a video input object.
%   This MATLAB code file, CONVEYOR.M, was generated from the OBJ2MFILE function.
...
%   type the name of the code file, conveyor, at the MATLAB command prompt.
%   
%   The code file, CONVEYOR.M and its associated MAT-file, CONVEYOR.MAT (if
...
try
    MATvar = load('C:\Users\student\Desktop\conveyor');
    MATLoaded = true;
catch
...
% Configure properties whose values are saved in C:\Users\student\Desktop\conveyor.mat.
if (MATLoaded)
